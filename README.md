...
- Ruff <sup>[Docs](https://docs.astral.sh/ruff/) | [Github](https://github.com/astral-sh/ruff) | [Pypi](https://pypi.org/project/ruff/) | [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=charliermarsh.ruff)</sup> - An extremely fast Python linter and code formatter, written in Rust. [Config file](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.tools/v1/configs/ruff.toml) | [AzDO pipeline](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.azuredevops/templates/linter_ruff_v01.yml) | [DevContainer config](#ruff)
...
- Python Build <sup>[Website](https://packaging.python.org) | [Docs](https://build.pypa.io) | [Pypi](https://pypi.org/project/build/)</sup> - A simple, correct Python packaging build frontend. [AzDO pipeline](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.azuredevops/templates/build_wheel_bdist_v01.yml)
