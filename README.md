...
- **Coverage** <sup>[coverage.py](https://coverage.readthedocs.io/)</sup>: Checks code coverage of Python tests with coverage.py. [Config file](https://github.com/KrijnvanderBurg/DevOps-Toolkit/blob/main/.tools/v1/configs/.coveragerc) | [AzDO pipeline](https://github.com/KrijnvanderBurg/DevOps-Toolkit/blob/main/.azuredevops/v1/templates/test_pytest.yml) | [DevContainer config](#pytest)
