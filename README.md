...
- DevSkim <sup>[Docs](https://github.com/microsoft/DevSkim/wiki) | [Github](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.tools/v1/configs/.devskim) | [Download](https://github.com/microsoft/DevSkim?tab=readme-ov-file#command-line-interface)</sup> - DevSkim is a framework of IDE extensions and language analyzers that provide inline security analysis in the dev environment as the developer writes code. It has a flexible rule model that supports multiple programming languages. The goal is to notify the developer as they are introducing a security vulnerability in order to fix the issue at the point of introduction, and to help build awareness for the developer. [VS code extension has no option to load config file] [Config file](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.tools/v1/configs/.devskim) | [AzDO pipeline](https://github.com/KrijnvanderBurg/DevOps-Toolkit/tree/main/.azuredevops/v1/templates/scanner_devskim.yml) | [DevContainer config](#devskim)
